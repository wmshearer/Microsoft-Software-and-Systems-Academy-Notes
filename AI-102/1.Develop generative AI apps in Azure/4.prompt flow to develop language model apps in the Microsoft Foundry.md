...
## Prompts and flows
A prompt is the input given to an LLM application, such as a question, instruction, or set of guidelines that drive the model’s output. Prompt effectiveness depends on how clearly it conveys intent and desired outcome.
