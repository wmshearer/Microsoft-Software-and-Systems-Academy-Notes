...
| Type                        | What they are used for?                                                                                   |                   |  |
|----------------------------|------------------------------------------------------------------------------------------------------|-------------------------------------|---------------|
| **Block Blobs**          | most common; optimized for upload/download |
| **Append Blobs**    | optimized for log writing |
| **Page Blobs**    | basis of Azure Managed Disks (VM disks) |
